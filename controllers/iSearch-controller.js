...
const iSearchLocationName = async (req, res, next) => {
    ...
    const sql = `SELECT id, username, fullName, state, latitude, longitude, picture, (((acos(sin(('${coordinates.lat}'*pi()/180)) * sin((latitude*pi()/180)) +
...
const iSearchGeoLocation = (req, res, next) => {
    ...
    const sql = `SELECT id, username, fullName, state, latitude, longitude, picture, (((acos(sin(('${latitude}'*pi()/180)) * sin((latitude*pi()/180)) +
